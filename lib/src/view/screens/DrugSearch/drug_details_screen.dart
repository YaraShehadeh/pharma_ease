...
import 'package:pharmaease/src/view/widgets/medical_interactions_dialogue.dart';

class DrugDetailsScreen extends StatefulWidget {
  String drugName;

  DrugDetailsScreen({Key? key, required this.drugName}) : super(key: key);
                            ...
                            onTap: () {
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return MedicalInteractionsPopUP(
                                      interactions:
                                          drug!.drugInteractions.toString());
                                },
                              );
                            },
                            child: const Icon(
