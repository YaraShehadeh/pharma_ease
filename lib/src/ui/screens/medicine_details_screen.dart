...
//   const MedicineDetailsScreen({Key? key})
//       : super(key: key);
//
//   @override
...
//   void initState() {
//     super.initState();
//     fullText = cubit.drugs.drugDescription;
//     updateSummaryText();
//   }
//
...
//         ],
//       ),
//       body: BlocBuilder<DrugCubit, DrugState>(
...
//               child: Column(
//                 children: [
//                   if (cubit.drugs.drugImage.length == 1)
//                     Image.asset(
//                       cubit.drugs.drugImage[0],
//                       height: 350,
...
//                         children: [
//                           PageView.builder(
//                             itemCount: cubit.drugs.drugImage.length,
...
//                               children: [
//                                 Text(
//                                   "Available in  ${cubit.drugs
//                                       .holdingPharmacies} pharmacies near you",
