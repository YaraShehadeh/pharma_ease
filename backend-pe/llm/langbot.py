...
class Lang():
    ...
    def __init__(self,key= "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"):
        self.key=key
    ...
    def return_vectore_store(self):
        embeddings = OpenAIEmbeddings(openai_api_key="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")
        pinecone = PinecoinOperations()
        index_name = "gp"
        vector_store = Pinecone.from_existing_index(index_name, embeddings)
        return vector_store
    ...
    def qa(self, vector_store_q, query):
        llm = ChatOpenAI(model="gpt-3.5-turbo", openai_api_key="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")
